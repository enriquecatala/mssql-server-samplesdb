...
--        (NAME = N'pubs' , FILENAME= N'/var/opt/mssql/data/Pubs.mdf'  )
--        LOG ON (NAME= N'pubs_log', FILENAME= N'/var/opt/mssql/data/Pubs_log.ldf');
...
--        (NAME = N'Northwind' , FILENAME= N'/var/opt/mssql/data/Northwind.mdf'  )
--        LOG ON (NAME= N'Northwind_log', FILENAME= N'/var/opt/mssql/data/Northwind_log.ldf');
...
--        (NAME = N'AdventureWorks2017' , FILENAME= N'/var/opt/mssql/data/AdventureWorks2017.mdf'  )
--        LOG ON (NAME= N'AdventureWorks2017_log', FILENAME= N'/var/opt/mssql/data/AdventureWorks2017_log.ldf');
...
--        (NAME = N'AdventureWorks2016' , FILENAME= N'/var/opt/mssql/data/AdventureWorks2016.mdf'  )
--        LOG ON (NAME= N'AdventureWorks2016_log', FILENAME= N'/var/opt/mssql/data/AdventureWorks2016_log.ldf');
...
--        (NAME = N'AdventureWorks2014' , FILENAME= N'/var/opt/mssql/data/AdventureWorks2014.mdf'  )
--        LOG ON (NAME= N'AdventureWorks2014_log', FILENAME= N'/var/opt/mssql/data/AdventureWorks2014_log.ldf');
...
--        (NAME = N'AdventureWorks2012' , FILENAME= N'/var/opt/mssql/data/AdventureWorks2012.mdf'  )
--        LOG ON (NAME= N'AdventureWorks2012_log', FILENAME= N'/var/opt/mssql/data/AdventureWorks2012_log.ldf');
...
-- ON PRIMARY
--        (NAME = N'WWI_Primary', FILENAME = N'/var/opt/mssql/data/WideWorldImporters.mdf'),
--        (NAME = N'WWI_UserData',FILENAME = N'/var/opt/mssql/data/WideWorldImporters_UserData.ndf'),
-- 	   (NAME = N'WWIDW_InMemory_Data_1',FILENAME = N'/var/opt/mssql/data/WideWorldImporters_InMemory_Data_1')	   
-- 	   LOG ON (NAME = N'WWI_Log',FILENAME = N'/var/opt/mssql/data/WideWorldImporters.ldf');
-- GO
